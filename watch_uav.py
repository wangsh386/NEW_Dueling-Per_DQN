...
space_dim = 91 # n_spaces   状态空间维度
action_dim = 5 # n_actions   动作空间维度
threshold = 200 
...
if __name__ == '__main__':
    ...
    for i in range(n_test):
        ...
        print(len(env.uavs[0].listdone))
        print(total_reward)
        print(info)
        env.ax.scatter(env.target[0].x, env.target[0].y, c='red')
        plt.show()
        plt.pause(100) 
